// app.js — kun midtersektionerne: kort-grid + værktøjer + kontakt
...
function Section({ title, children }) {
  return React.createElement(
    ...
    [ title ? React.createElement("h2", { key:"h", className:"text-xl font-semibold mb-4" }, title) : null, children ]
  );
}
function Card({ title, description, children }) {
  return React.createElement("div", { className:"rounded-2xl border p-4 shadow-sm bg-white" }, [
    (title || description) ? React.createElement("div", { key:"hd", className:"mb-3" }, [
      title && React.createElement("h3", { key:"t", className:"text-lg font-semibold leading-tight" }, title),
      description && React.createElement("p", { key:"d", className:"text-sm text-neutral-600 mt-1" }, description),
    ]) : null,
    children
  ]);
}
function TextInput({ label, value, onChange, placeholder, textarea=false, rows=3 }) {
  return React.createElement("label", { className:"block mb-3" }, [
    label && React.createElement("span", { key:"l", className:"block text-sm font-medium mb-1" }, label),
    textarea
...
function CopyButton({ getText, label="Kopiér" }) {
  ...
  return React.createElement("button", {
    onClick: async ()=>{ try{ await navigator.clipboard.writeText(getText()); setCopied(true); setTimeout(()=>setCopied(false),1500);}catch(e){ alert("Kunne ikke kopiere."); } },
...
/* ---------- Sektioner ---------- */
function GridLinks() {
  return React.createElement("section", { className:"grid md:grid-cols-4 gap-4" }, [
    React.createElement("a", { key:"serp", className:"rounded-2xl border p-4 bg-white hover:shadow", href:"/serp-preview.html" }, [
    ...
    React.createElement("a", { key:"robots", className:"rounded-2xl border p-4 bg-white hover:shadow", href:"/robots-generator.html" }, [
    ...
    React.createElement("a", { key:"sitemap", className:"rounded-2xl border p-4 bg-white hover:shadow", href:"/sitemap-generator.html" }, [
...
function SerpAndMeta() {
  ...
  return React.createElement(Section, { title:"SERP preview & title/meta tjek" },
    React.createElement("div", { className:"grid md:grid-cols-2 gap-6" }, [
      React.createElement(Card, { key:"form", title:"Indtast oplysninger", description:"Realtime længdeindikatorer" }, [
      ...
      React.createElement(Card, { key:"prev", title:"Google-lignende forhåndsvisning", description:"Simuleret visning" },
...
function FaqSchema() {
  ...
  return React.createElement(Section, { title:"FAQ schema (JSON-LD)" },
    React.createElement("div", { className:"space-y-4" }, [
      ...pairs.map((p,i)=> React.createElement("div", { key:i, className:"grid md:grid-cols-2 gap-3" }, [
...
function App() {
  return React.createElement(React.Fragment, null, [
    React.createElement(GridLinks, { key:"grid" }),
